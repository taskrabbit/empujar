            ...
            complete: function(err, stmt, rows) {
                ...
                if (err) {
                    ...
                    if(String(query).includes('INSERT INTO EMPUJAR')  ) {
                        self.book.logger.log('Empujar insert , Connection Id ' + stmt.getStatementId() + ' Payload Info : ' + String(data), 'debug');
                    }
                    else if(String(query).includes('SHOW TABLES')  )  {
                        self.book.logger.log('Show tables , Connection Id ' + stmt.getStatementId() + ' Payload Info : ' + String(data), 'debug');
                    }
