...
var hashMerge = function(options, defaults){
  if(!options){ options = {}; }
  var response = {};
  var key;
...
var doInFork = function(func, args, requires, callback){
  var child = child_process.fork(__dirname + '/childProcess.js');

  if(requires === null || requires === undefined){ requires = []; }
